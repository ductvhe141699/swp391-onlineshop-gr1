  ...
  <body style="min-height: 2000px">
    ...
    <nav class="navbar main-navbar navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid">
        <!-- LOGO -->
        <a class="navbar-brand col-lg-2 offset-lg-2 logo" href="#"
          ><img src="resources/img/SHOPE-logos_transparent.png" />
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="d-flex searchbar">
            ...
            <button class="btn btn-danger" type="submit">
              <i class="fas fa-search" style="font-size: 100%"></i>
            </button>
          </form>
