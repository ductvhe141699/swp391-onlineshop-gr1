                ...
                <li class="nav-item dropdown d-none d-lg-block">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <c:if test ="${sessionScope.user !=  null}">
                            ...
                            <li><hr class="dropdown-divider"></li>
                            <!--Dẫn người dùng đến trang 'xem hồ sơ cá nhân' LamDTHE153097-->
                            <li><a class="dropdown-item" href="${pageContext.request.contextPath}/ProfileControl">View Profile</a></li>
                            <li><hr class="dropdown-divider"></li>
                            </c:if>
                            <!--Nếu có vai trò là người quản lý, thì có thêm chức năng quản lý người dùng LamDTHE153097-->
                            <c:if test ="${sessionScope.user.roleID ==  1}">
                            <li><a class="dropdown-item" href="${pageContext.request.contextPath}/AccountManagerControl">Manage User</a></li>                            
                            </c:if>
